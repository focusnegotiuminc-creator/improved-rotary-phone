...
- [x] Smoke test all core local workflow commands.

## Final status
- Local workflow is complete and reproducible with Make targets (`run`, `qa`, `visual-check`, `publish`).
- Git commits are saved in this repository; direct GitHub push requires a configured remote and credentials.
